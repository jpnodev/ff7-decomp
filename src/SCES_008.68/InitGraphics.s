...
nonmatching InitGraphics, 0x15C
...
glabel InitGraphics
    ...
    /* 340B8 800438B8 0680013C */  lui        $at, %hi(IsGraphInitialized)
    /* 340BC 800438BC B52B23A0 */  sb         $v1, %lo(IsGraphInitialized)($at)
    /* 340C0 800438C0 80100200 */  sll        $v0, $v0, 2
    /* 340C4 800438C4 0680013C */  lui        $at, %hi(ResolutionWidthArray)
    /* 340C8 800438C8 342C2124 */  addiu      $at, $at, %lo(ResolutionWidthArray)
    ...
    /* 340E0 800438E0 0680013C */  lui        $at, %hi(ActiveBufferWidth)
    /* 340E4 800438E4 B82B23A4 */  sh         $v1, %lo(ActiveBufferWidth)($at)
    /* 340E8 800438E8 0680013C */  lui        $at, %hi(ResolutionHeightArray)
    /* 340EC 800438EC 482C2124 */  addiu      $at, $at, %lo(ResolutionHeightArray)
    /* 340F0 800438F0 21082200 */  addu       $at, $at, $v0
    /* 340F4 800438F4 00002294 */  lhu        $v0, 0x0($at)
    /* 340F8 800438F8 00000000 */  nop
    /* 340FC 800438FC 0680013C */  lui        $at, %hi(ActiveBufferHeight)
    /* 34100 80043900 BA2B22A4 */  sh         $v0, %lo(ActiveBufferHeight)($at)
  ...
  .L80043928:
    ...
    /* 34148 80043948 0680023C */  lui        $v0, %hi(printf_ptr)
    /* 3414C 8004394C B02B428C */  lw         $v0, %lo(printf_ptr)($v0)
